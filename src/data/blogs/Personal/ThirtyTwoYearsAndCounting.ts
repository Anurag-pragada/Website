...
export const ThirtyTwoYearsAndCounting: BlogPost = {
  ...
  "I don't want to die with all my knowledge. I love to give my knowledge to those who need it.",
  {
    ...
    text: [
      "I created my ",
      { type: "link", text: "Udemy courses", url: "https://www.udemy.com/user/srikanth-pragada/" },
      ", ",
      { type: "link", text: "Blogs", url: "/blogs" },
      " and ",
      { type: "link", text: "Video Tutorials", url: "https://www.youtube.com/user/srikanthpragada" },
      " in an attempt to share my knowledge beyond the walls of my classroom. The moto has been sharing."
    ]
  },
  ...
  {type: "paragraph", text: "This is my sincere attempt to give you (my student) more ways to learn and enrich your skills."}
]
};
