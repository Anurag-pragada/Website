...
export const What_I_Learned_In_The_Last_six_years: BlogPost = {
    ...
    category: "Personal",
    date: "26-08-2023",
    intro: ["Every IT pro has to constantly learn new things to be relevant and embrace current trends. I am no exception and more so as I have to teach next generation programmers, I have to be always on cutting edge.",
    ...
    items: [
      "Python Language",
      "Django Framework",
      "Data Science related libraries and Machine learning concepts",
      "React",
      ".Net Core upgrade from .NET Framework",
      "AWS (Including becoming AWS Certified Cloud Practitioner)",
      "Node.js",
      "Express.js",
      "MongoDB"
    ]
